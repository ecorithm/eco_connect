from eco_connect.errors import InvalidRequest
...
class BaseRequest:
    ...
    def _format_response(self, response,
        ...
        if response.status_code == 200 or response.status_code == 201:
            ...
            try:
                raise InvalidRequest(response.status_code, response.json())
            except ValueError:
                raise InvalidRequest(response.status_code, response.text)
