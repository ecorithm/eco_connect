...
class TestFactsService:
    ...
    def test__init__(self, mocker):
        ...
        assert facts_service.hostname == "https://facts.prod.ecorithm.com/api/v1/"
    ...
    def test_get_facts_json(self, mocker, facts_service):
        ...
        expected_parser = mocker.patch(self.MODULE_PATH + ".RequestParser.json_parser")

        mock_response = mocker.Mock()
        mock_post = mocker.patch.object(
            facts_service, "post", return_value=mock_response
        )

        mock_format_result = mocker.patch.object(facts_service, "_format_response")

        mock_format_result.return_value = "parsed_result"

        result = facts_service.get_facts(
            building_id,
            start_date,
            end_date,
            start_hour,
        ...
        mock_format_result.assert_called_with(mock_response, expected_parser, {})
        mock_post.assert_called_with(
            "https://facts.prod.ecorithm.com/api/v1/building/1/facts",
            data={
    ...
    def test_get_facts_pandas(self, mocker, facts_service):
        ...
        expected_parser = mocker.patch.object(facts_service, "_pandas_fact_parser")
        ...
        mock_format_result.assert_called_with(
            mock_response, expected_parser, {"data_key": "data"}
        )
        mock_post.assert_called_with(
            "https://facts.prod.ecorithm.com/api/v1/building/1/facts",
            data={
    ...
    def test_get_facts_tuple(self, mocker, facts_service):
        ...
        expected_parser = mocker.patch.object(facts_service, "_tuple_fact_parser")
    ...
    def test_get_facts_csv(self, mocker, facts_service):
        ...
        expected_parser = mocker.patch.object(facts_service, "_csv_fact_parser")
    ...
    def test_get_facts_value_error(self, mocker, facts_service):
        ...
        with pytest.raises(ValueError):
            facts_service.get_facts(
                building_id, start_date, end_date, result_format="arrow"
            )
    ...
    def test__tuple_fact_parser(self, mocker, facts_service):
        ...
        mock_response.json.return_value = {
            "data": {
                "1": {
                    "data": {"2017-08-01 00:00": 67.5, "2017-08-01 00:05": 68.5},
                    "meta": {
                ...
                "2": {
                    "data": {"2017-08-01 00:00": 0, "2017-08-01 00:05": 100},
                    "meta": {
        ...
        expected_result = [
            expected_named_tuple(
                ...
                **{"fact_time": "2017-08-01 00:00", "fact_value": 67.5}
            ),
            expected_named_tuple(
                **{
                    "display_name": "SpaceTemp",
                ...
                **{"fact_time": "2017-08-01 00:05", "fact_value": 68.5}
            ),
            expected_named_tuple(
                **{
                    "display_name": "Cooling",
                ...
                **{"fact_time": "2017-08-01 00:00", "fact_value": 0}
            ),
            expected_named_tuple(
                **{
                    "display_name": "Cooling",
                ...
                **{"fact_time": "2017-08-01 00:05", "fact_value": 100}
            ),
        ]
    ...
    def test__pandas_fact_parser(self, mocker, facts_service):
        mock__tuples_fact_parser = mocker.patch.object(
            facts_service, "_tuple_fact_parser"
        )
        tuple_names = [
            "fact_time",
            "fact_value",
        ...
        expected_df = pd.DataFrame(
            ...
            data=[
                ...
                [
                    ...
                    "Cooling",
                    2,
                    "UCSB/275/VAV_301/NAE11/N2-2.275-VAV-301.CV",
                    "VAV_301",
                    "VAV",
    ...
    def test__csv_fact_parser(self, mocker, facts_service):
        ...
        mocker.patch.object(facts_service, "_pandas_fact_parser", return_value=mock_df)
        facts_service._csv_fact_parser(mock_response)

    def test_get_avg_facts_json(self, mocker, facts_service):
        mock_response = mocker.Mock()
        mock_json_parser = mocker.patch(self.MODULE_PATH + ".RequestParser.json_parser")
        mock_get = mocker.patch.object(facts_service, "post")
        mock_get.return_value = mock_response
        mock_format_response = mocker.patch.object(facts_service, "_format_response")
        ...
        result = facts_service.get_avg_facts(
            building_id, **mock_params, result_format=result_format
        )
        assert result == "parsed_result"
        ...
        mock_format_response.assert_called_once_with(
            mock_response, parser=mock_json_parser, parser_args={}
        )

    def test_get_avg_facts_pandas(self, mocker, facts_service):
        mock_response = mocker.Mock()
        mock_pandas_parser = mocker.patch.object(facts_service, "_pandas_fact_parser")
        mock_get = mocker.patch.object(facts_service, "post")
        mock_get.return_value = mock_response
        mock_format_response = mocker.patch.object(facts_service, "_format_response")
        mock_format_response.return_value = "parsed_result"
        ...
        mock_format_response.assert_called_once_with(
            mock_response, parser=mock_pandas_parser, parser_args={"data_key": "data"}
        )

    def test_get_avg_facts_dqi_tuple(self, mocker, facts_service):
        mock_response = mocker.Mock()
        mock_pandas_parser = mocker.patch.object(facts_service, "_tuple_fact_parser")
        mock_get = mocker.patch.object(facts_service, "post")
        mock_get.return_value = mock_response
        mock_format_response = mocker.patch.object(facts_service, "_format_response")
        mock_format_response.return_value = "parsed_result"
    ...
    def test_get_avg_facts_csv(self, mocker, facts_service):
        mock_response = mocker.Mock()
        mock_pandas_parser = mocker.patch.object(facts_service, "_csv_fact_parser")
        mock_get = mocker.patch.object(facts_service, "post")
        mock_get.return_value = mock_response
        mock_format_response = mocker.patch.object(facts_service, "_format_response")
        mock_format_response.return_value = "parsed_result"
    ...
    def test_get_avg_facts_invalid(self, mocker, facts_service):
        mocker.patch.object(facts_service, "post")
        mocker.patch.object(
            facts_service, "_format_response", return_value="parsed_result"
        )
        building_id = 26
    ...
    def test_put_facts(cls, mocker, facts_service):
        mock_put_facts = pd.DataFrame(
            columns=["native_name", "fact_value", "fact_time"],
            data=[
                ["native_name-1", 1, "2017-12-20 00:00"],
                ["native_name-2", 2, "2017-12-21 00:00"],
            ],
        )
        mock_response = mocker.Mock()
        mock_put = mocker.patch.object(facts_service, "put", return_value=mock_response)
        mock__get_parser = mocker.patch.object(
            facts_service,
            "_get_parser",
            return_value={"parser": "parser", "parser_args": "args"},
        )
        mock_parse_result = mocker.patch.object(
            facts_service, "_format_response", return_value=mock_response
        )
    ...
    def test_get_buildings(self, mocker, facts_service):
        ...
        is_active = True
        result_format = "pandas"
        expected_url = "https://facts.prod.ecorithm.com/api/v1/buildings"
        mock_get = mocker.patch.object(
            facts_service, "get", return_value="mock-response"
        )
        params = {"building_id": building_id, "is_active": is_active}
        mock__get_parser = mocker.patch.object(
            facts_service,
            "_get_parser",
            return_value={"parser": "mock-parser", "parser_args": {"arg": 1}},
        )
        mock__format_response = mocker.patch.object(
            facts_service, "_format_response", return_value=("formated-result")
        )
        result = facts_service.get_buildings(building_id, is_active, result_format)
        mock_get.assert_called_once_with(expected_url, data=params)
        mock__get_parser.assert_called_once_with("pandas", data_key="data")
        mock__format_response.assert_called_once_with(
            "mock-response", parser="mock-parser", parser_args={"arg": 1}
        )
    ...
    def test_put_building(self, mocker, facts_service):
        ...
        mock_response = mocker.Mock()
        mock_parser = {"parser": "mock_parser", "parser_args": {}}
        mock_put = mocker.patch.object(facts_service, "put", return_value=mock_response)
        mock__get_parser = mocker.patch.object(
            facts_service, "_get_parser", return_value=mock_parser
        )
        mock_format_response = mocker.patch.object(facts_service, "_format_response")
        mock_format_response.return_value = "parse_get_result"
        result = facts_service.put_building(
            building=mock_building_name, building_id=mock_building_id
        )
        assert result == "parse_get_result"
        mock__get_parser.assert_called_once_with("json")
        mock_put.assert_called_once_with(
            "https://facts.prod.ecorithm.com/api/v1/buildings",
            data={
    ...
    def test_delete_building(self, mocker, facts_service):
        ...
        mock_delete = mocker.patch.object(
            facts_service, "delete", return_value=mock_response
        )
        mock__get_parser = mocker.patch.object(
            facts_service, "_get_parser", return_value=mock_parser
        )
        ...
        mock_delete.assert_called_once_with(
            "https://facts.prod.ecorithm.com/api/v1/buildings",
            data={"building_id": mock_building_id},
        )
    ...
    def test_get_point_classes(self, mocker, facts_service):
        ...
        is_active = True
        result_format = "pandas"
        expected_url = "https://facts.prod.ecorithm.com/api/v1/point-classes"
        mock_get = mocker.patch.object(
            facts_service, "get", return_value="mock-response"
        )
        ...
        result = facts_service.get_point_classes(point_class, is_active, result_format)
        mock_get.assert_called_once_with(expected_url, data=params)
        mock__get_parser.assert_called_once_with("pandas", data_key="data")
        mock__format_response.assert_called_once_with(
            "mock-response", parser="mock-parser", parser_args={"arg": 1}
    ...
    def test_put_point_class(self, mocker, facts_service):
        ...
        result = facts_service.put_point_class(
            point_class_id=mock_point_class_id, point_class=mock_point_class
        )
        assert result == "parse_get_result"
        mock__get_parser.assert_called_once_with("json")
        mock_put.assert_called_once_with(
    ...
    def test_get_point_mapping(self, mocker, facts_service):
        ...
        is_active = True
        result_format = "pandas"
        expected_url = "https://facts.prod.ecorithm.com/api/v1/building/1/point-mapping"
        mock_get = mocker.patch.object(
            facts_service, "get", return_value="mock-response"
        )
        data = {
    ...
    def test_delete_point_mapping(self, mocker, facts_service):
        expected_url = (
            "https://facts.prod.ecorithm.com/api/v1/building/26/point-mapping"
        )
        mock_get = mocker.patch.object(
            facts_service, "delete", return_value="mock-response"
        )
        mock__get_parser = mocker.patch.object(
            facts_service,
            "_get_parser",
        ...
        result = facts_service.delete_point_mapping(
            building_id=26, eco_point_ids=[1, 2, 3]
        )
        mock_get.assert_called_once_with(
            expected_url, data=mock_payload, encode_type="form"
        )
        mock__get_parser.assert_called_once_with("json")
        mock__format_response.assert_called_once_with(
            "mock-response", parser="mock-parser", parser_args={"arg": 1}
    ...
    def test_put_point_mapping(self, mocker, facts_service):
        ...
        mock_put = mocker.patch.object(
            facts_service, "put", return_value="mock-response"
        )
        mock__get_parser = mocker.patch.object(
            facts_service,
            "_get_parser",
        ...
        result = facts_service.put_point_mapping(building_id=26, point_mapping=mock_df)
        put_input = [
            {
                "equipment_name": "VAV_01",
                "equipment_type": "VAV",
        ...
        mock_put.assert_called_once_with(
            expected_url, data=put_input, encode_type="json"
        )
        assert result == "formated-result"
    ...
    def test_get_equipment_types(self, mocker, facts_service):
        ...
        is_active = True
        result_format = "pandas"
        expected_url = "https://facts.prod.ecorithm.com/api/v1/equipment-types"
        mock_get = mocker.patch.object(
            facts_service, "get", return_value="mock-response"
        )
        ...
        result = facts_service.get_equipment_types(
            equipment_type, is_active, result_format
        )
        mock_get.assert_called_once_with(expected_url, data=params)
        mock__get_parser.assert_called_once_with("pandas", data_key="data")
        mock__format_response.assert_called_once_with(
    ...
    def test_put_equipment_type(self, mocker, facts_service):
        ...
        mock_payload = {"equipment_type": "name-1", "equipment_type_id": 123}
        result = facts_service.put_equipment_type(
            equipment_type="name-1", equipment_type_id=123
        )
        mock_get.assert_called_once_with(
            expected_url, data=mock_payload, encode_type="form"
        )
    ...
    def test_get_equipment(self, mocker, facts_service):
        ...
        is_active = True
        result_format = "pandas"
        expected_url = "https://facts.prod.ecorithm.com/api/v1/building/1/equipment"
        mock_get = mocker.patch.object(
            facts_service, "get", return_value="mock-response"
        )
        params = {
        ...
        result = facts_service.get_equipment(
            building_id=building_id,
            equipment_name=equipment_name,
            equipment_type=equipment_type,
            is_active=is_active,
    ...
    def test_delete_equipment(self, mocker, facts_service):
        expected_url = "https://facts.prod.ecorithm.com/api/v1/building/26/equipment"
        mock_get = mocker.patch.object(
            facts_service, "delete", return_value="mock-response"
        )
        mock__get_parser = mocker.patch.object(
        ...
        result = facts_service.delete_equipment(
            building_id=26, equipments=["name-1", "name-2"]
        )
        mock_get.assert_called_once_with(
            expected_url, data=mock_payload, encode_type="form"
        )
    ...
    def test_put_equipment(self, mocker, facts_service):
        mock_data = [["VAV_01", "VAV", 3], ["AHU_01", "AHU", 4]]
        mock_columns = ["equipment_name", "equipment_type", "equipment_id"]
        mock_put = mocker.patch.object(
            facts_service, "put", return_value="mock-response"
        )
        mock__get_parser = mocker.patch.object(
        ...
        result = facts_service.put_equipment(building_id=26, equipments=mock_df)
        put_input = [
            {"equipment_name": "VAV_01", "equipment_type": "VAV", "equipment_id": 3},
            {"equipment_name": "AHU_01", "equipment_type": "AHU", "equipment_id": 4},
        ]
        expected_url = "https://facts.prod.ecorithm.com/api/v1/building/26/equipment"
        mock_put.assert_called_once_with(
            expected_url, data=put_input, encode_type="json"
    ...
    def test_get_native_names(self, mocker, facts_service):
        ...
        is_active = True
        result_format = "pandas"
        expected_url = "https://facts.prod.ecorithm.com/api/v1/building/1/native-names"
        mock_get = mocker.patch.object(
            facts_service, "get", return_value="mock-response"
        )
        ...
        result = facts_service.get_native_names(
            building_id, native_name, is_active, result_format
        )
        mock_get.assert_called_once_with(expected_url, data=params)
        mock__get_parser.assert_called_once_with("pandas", data_key="data")
        mock__format_response.assert_called_once_with(
    ...
    def test_put_native_names(self, mocker, facts_service):
        mock_data = [
            ["VAV_01", True, "Client", 3, "COV", "5 minutes"],
            ["VAV_02", True, "Client", 4, "COV", "5 minutes"],
        ]
        mock_columns = [
            "native_name",
            "expecting_data",
        ...
        result = facts_service.put_native_names(building_id=26, native_names=mock_df)
        put_input = [
            {
                "native_name": "VAV_01",
                "expecting_data": True,
        ...
        expected_url = "https://facts.prod.ecorithm.com/api/v1/building/26/native-names"
        mock_put.assert_called_once_with(
            expected_url, data=put_input, encode_type="json"
        )
        assert result == "formated-result"
    ...
    def test_delete_native_names(self, mocker, facts_service):
        ...
        result = facts_service.delete_native_names(
            building_id=26, native_names=["name-1", "name-2"]
        )
        mock_get.assert_called_once_with(
            expected_url, data=mock_payload, encode_type="form"
        )
    ...
    def test_get_native_names_history(self, mocker, facts_service):
        expected_url = (
            "https://facts.prod.ecorithm.com/api/v1/building/26/native-name-history"
        )
        mock_get = mocker.patch.object(
            facts_service, "get", return_value="mock-response"
        )
    ...
    def test_get_unmapped_native_names(self, mocker, facts_service):
        expected_url = (
            "https://facts.prod.ecorithm.com/api/"
    ...
    def test_get_etl_process_history(self, mocker, facts_service):
        expected_url = (
            "https://facts.prod.ecorithm.com/api/v1/building/26/etl-process-history"
        )
        mock_get = mocker.patch.object(
            facts_service, "get", return_value="mock-response"
        )
        ...
        result = facts_service.get_etl_process_history(building_id=26, return_limit=10)
        mock_get.assert_called_once_with(expected_url, data={"return_limit": 10})
        mock__get_parser.assert_called_once_with("json")
        mock__format_response.assert_called_once_with(
            "mock-response", parser="mock-parser", parser_args={"arg": 1}
        )
    ...
    def test_get_unstored_native_names(self, mocker, facts_service):
        expected_url = (
            "https://facts.prod.ecorithm.com/api/v1/building/26/unstored-native-names"
        )
        mock_get = mocker.patch.object(
            facts_service, "get", return_value="mock-response"
        )
    ...
    def test_get_last_native_name_record(self, mocker, facts_service):
        expected_url = (
            "https://facts.prod.ecorithm.com/api/v1/building/26/last-native-name-record"
        )
        mock_get = mocker.patch.object(
            facts_service, "get", return_value="mock-response"
        )
        ...
        result = facts_service.get_last_native_name_record(
            building_id=26, native_name="native-name-1", max_time="2017-12-20 00:00"
        )
        mock_get.assert_called_once_with(
            expected_url,
            data={"native_name": "native-name-1", "max_time": "2017-12-20 00:00"},
        )
        mock__get_parser.assert_called_once_with("json")
        mock__format_response.assert_called_once_with(
            "mock-response", parser="mock-parser", parser_args={"arg": 1}
    ...
    def test_get_building_dqi_json(self, mocker, facts_service):
        ...
        result = facts_service.get_building_dqi(
            building_id, **mock_params, result_format=result_format
        )
        assert result == "parsed_result"
        mock_get.assert_called_once_with(
            "https://facts.prod.ecorithm.com/api/v1/building/26/dqi", data=mock_params
        )
        mock_format_response.assert_called_once_with(
            mock_response, parser=mock_json_parser, parser_args={}
        )
    ...
    def test_get_building_dqi_pandas(self, mocker, facts_service):
        mock_response = mocker.Mock()
        mock_pandas_parser = mocker.patch.object(facts_service, "_pandas_dqi_parser")
        mock_get = mocker.patch.object(facts_service, "get")
        mock_get.return_value = mock_response
        mock_format_response = mocker.patch.object(facts_service, "_format_response")
        mock_format_response.return_value = "parsed_result"
    ...
    def test_get_building_dqi_tuple(self, mocker, facts_service):
        mock_response = mocker.Mock()
        mock_pandas_parser = mocker.patch.object(facts_service, "_tuple_dqi_parser")
        mock_get = mocker.patch.object(facts_service, "get")
        mock_get.return_value = mock_response
        mock_format_response = mocker.patch.object(facts_service, "_format_response")
        mock_format_response.return_value = "parsed_result"
    ...
    def test_get_building_dqi_csv(self, mocker, facts_service):
        mock_response = mocker.Mock()
        mock_pandas_parser = mocker.patch.object(facts_service, "_csv_dqi_parser")
        mock_get = mocker.patch.object(facts_service, "get")
        mock_get.return_value = mock_response
        mock_format_response = mocker.patch.object(facts_service, "_format_response")
        mock_format_response.return_value = "parsed_result"
    ...
    def test__tuple_dqi_parser(self, mocker, facts_service):
        mock_response = mocker.Mock()
        mock_response.json.return_value = {
            "data": {"26": {"2017-12-20 00:00:00": 71.78, "2017-12-21 00:00:00": 72.78}}
        }
        ...
        expected_result = [
            response_tuple(
                **{"aggregate": "26", "timestamp": "2017-12-20 00:00:00", "dqi": 71.78}
            ),
            response_tuple(
                **{"aggregate": "26", "timestamp": "2017-12-21 00:00:00", "dqi": 72.78}
            ),
        ]
    ...
    def test__pandas_dqi_parser(self, mocker, facts_service):
        ...
        mocker.patch.object(
            facts_service, "_tuple_dqi_parser", return_value=mock_tuples
        )
        expected_data = [
    ...
    def test__csv_dqi_parser(self, mocker, facts_service):
        ...
        mock_response = mocker.Mock()
        mocker.patch.object(
            facts_service, "_tuple_dqi_parser", return_value=expected_df
        )

        result = facts_service._csv_dqi_parser(mock_response)
        assert result == (
            "aggregate,timestamp,dqi\n"
            "26,2017-12-20 00:00:00,71.78\n"
            "26,2017-12-21 00:00:00,72.78\n"
        )
